...
export Dynamic_permit_allocation, dynamic_permits, Equal_share_allocation, equal_share, Protected_area, protected_area,  Economic_incentive, economic_incentive
