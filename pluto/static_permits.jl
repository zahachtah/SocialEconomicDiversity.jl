...
function run(f)
	P=zeros(N)
	P[Int(round(N*f)):end].=1
	p=(N=N,α=0.1,w̃=range(0.1,stop=0.9,length=N),ū=range(0.5/N,stop=2.0/N,length=N), γ=γ,ϕ=ϕ, μ=μ,P=P)
...
manifest_format = "2.0"
project_hash = "8fffee22ae65b123778cf647871a6c9c5f7e2d9c"
