...
# ╔═╡ 606ff705-3424-40fd-8221-6119f30eed07
begin
...
# ╔═╡ ac50c3e0-3152-11f0-0f56-818fc3e55a1b
begin
	# =============================================================================
...
# ╔═╡ f7766454-b441-4ce4-9686-6250db050cf9
md"
# Sociall Economic Distributions model

adjust the distributions of w̃ and ū in the next cell and watch the figures update"

# ╔═╡ c410c92d-4e93-4f66-a23c-b51311aaac97
begin
	w̃=sed(min=0.01,max=0.9,distribution=LogNormal) 
	# distribution=LogNormal | Uniform
	# change the minimum and maximum of the distribution
    
    ū=sed(mean=2.0, sigma=-0.0, normalize=true, random=false)
    # set the mean as total impact, and normalize to divide by No of actors.
    # sigma=0 = constant for all, sigma value positive or negative = correlations
end

# ╔═╡ 0e83bfa1-77d6-4010-9336-aa4f1ee6a766
md"
Note that for protected area to be effective at regulation above zero you often need high ū~2.0 and low w̃ e.g. (min=0.01, max=0.5)"

# ╔═╡ c38839de-f27b-4962-8f63-2b5606e4d10c
md"
## Below are function definitions
I have them hidden"

# ╔═╡ 80343000-87cb-4bc9-9189-e4eaedf96f89
begin
...
# ╔═╡ 3471dfbb-3b80-4c60-b8ed-c68bb0e5fdb8
begin
	"""
...
# ╔═╡ e99d31ce-ab99-4178-bc25-9c201c5abaab
begin
	"""
...
# ╔═╡ 8d239f21-1646-4bac-b978-fae56d0284db
...
# ╔═╡ c1a0dbb8-9ccb-4539-b0ae-5c00e985565e
f=plot(w̃,ū, order=false,goal=:oToR)
# order=true orderes incomes according to total income, instead of index/w̃
# choose :oRR for resource revenue optima, :oToR for total optima or :oGI for gini
# R=resource revenue, T=total revenues, G=gini, @= regulation level


# ╔═╡ 6e749a45-5514-408f-9680-61af3ad31505
...
# ╔═╡ 322db6bd-1e9c-429b-896f-7be6ce43db7e
regscan(s=scenario(base(),w̃=w̃,ū=ū), u=true)
#if you don't need the regulation scan graph you can just comment the regscan or disable the cell
...
manifest_format = "2.0"
project_hash = "258a3d82e7f128fd3cd79d5878a3487ef29b30fb"
